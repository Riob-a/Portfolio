...
function Test() {
    ...
    return (
        <div>
            ...
            <section id="skills" className=" mt-4 mb-5 p-2">
                <Card className="py-5 mt-5 mb-5 rounded-4" data-aos="fade-right" data-aos-delay="300">
                    <Card.Body>
            ...
            {/* Projects Section */}
            <section id="projects" className="py-5 mb-5 mt-5">
